...
Looking at the table above, from **1991** to **2011**, the amounts of books published in those years alternates between **1** book and **2** books. In **2015**, we have our highest publish rate with **6** books in that year, then the following year it dips down again to **2** books. Then in **2018**, it suddenly jumps up to **4** books published, and for the last two years (**2019** and **2020**), we have **3** books published.
