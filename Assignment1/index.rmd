...
sausage_roll_frame = image_read(sausage_roll_url) %>% image_scale("500x500") %>% image_annotate("Sausage roll", size = 30, location = "+279+230", color = "white")
...
rick_roll_frame = image_read(rick_roll_url) %>%
  image_scale("500x500") %>%
  image_annotate("Rickroll", size = 30)
...
##  Learning Reflection {#learning-reflection}
During this assignment, I learned a LOT from Module 1 - Creating HTML by combining modern technologies. Coming from a prior programming background, I'm definitely keen and interested to learn more about what R can offer me and what advantages it may have compared to using other languages (e.g Python) for data analysis.